      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-background to-[#120c22]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gradient bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent font-playfair">
                    ...
                    <div className="p-6 flex-grow flex flex-col">
                      <div className="flex items-center mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400">{post.date} · {post.readingTime}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-auto">
                        {post.tags.map(tag => (
                          <span key={tag} className="text-xs px-2 py-1 bg-purple-900/40 text-purple-300 rounded">
                            {tag}
                          </span>
                        ))}
                      </div>

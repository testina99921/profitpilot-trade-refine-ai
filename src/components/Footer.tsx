        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-purple-400">Disclaimer</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="text-gray-400">
                ...
                <a href="mailto:support@profitpilot.com" className="text-purple-400 hover:text-purple-300">
